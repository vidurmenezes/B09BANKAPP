...
public class CurrentTellers extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_current_tellers);
    context = this.getApplicationContext();
    EnumMapRoles roleMap = new EnumMapRoles(context);
    mainListView = (ListView) findViewById(R.id.mainListViewteller);

    int ctr = 1;
    boolean loop = true;
    List<String> tellerUsers = new ArrayList<>();
    ...
    listAdapter = new ArrayAdapter<String>(this, R.layout.simplerow, tellerUsers);
    ...
    exit.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        Intent i = new Intent(CurrentTellers.this, Admin.class);
        startActivity(i);
      }
    });
